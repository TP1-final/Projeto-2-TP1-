        ...
        switch(campo){
            case 1: if(cntrApresentacaoAutenticacao->autenticar(&cpf)){                         // Solicita autentica��o.
                        ...
                        while(apresentar){
                            ...
                            switch(campo){
                                case 1: cntrApresentacaoContas->executar(cpf);                 // Solicita servi�o de pessoal.
                                        break;
                                case 2: cntrApresentacaoInvestimentos->executar(cpf);     // Solicita servi�o de produto financeiro.
                                        break;
...
bool CntrApresentacaoAutenticacao::autenticar(Cpf *cpf){
    ...
    while(true){
        ...
        try{
            ...
            getch();
            return false;                                                                            // L� caracter digitado.
        }
    }
