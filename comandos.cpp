...
string linha, codigo = ordem.getCodigoNegociacao().getValor();                    // Código do papel procurado composto por 12 caracteres.
codigo.resize(12, ' ');
...
void ComandoApresentacaoInvestimentosListarOrdens::executar(IServicoInvestimentos *cntrServicoInvestimentos, Cpf cpf){
    ...
    list<Ordem> ordens = cntrServicoInvestimentos->listarOrdens(codigoCarteira);
